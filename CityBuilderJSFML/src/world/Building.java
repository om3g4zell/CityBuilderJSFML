...
public class Building {
	...
	/**
	 * Returns the building type which generates the given resource type.
	 ...
	 * @param position : the position of the top left, in tiles coordinates
	 */
	...
	/**
	 * Generates resources.
	 * @param resourcesMap : resource map to place resources on
	 */
	...
	/**
	 * Consumes one 
	 * @param resourcesMap : the resource map to get resources from
	 * @param resourceType : the resource type to consume
	 * @param amount : the amount of resource to consume
	 * @param fillFactor : the fill factor to apply to the amount
	 */
	 ...
	 * Consumes resources.
	 * @param resourcesMap : the resource map to get resources from
	 * @return the building type required to fullfill this building needs
	 */
